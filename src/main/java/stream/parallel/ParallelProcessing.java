...
//        return LongStream.rangeClosed(1, limit).parallel().sum();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The best process time(iterateStream)=>" + measureSumPerformance(ParallelProcessing::iterateStream, 1_000_000) + " MS");
        System.out.println("The best process time(parallelStream)=>" + measureSumPerformance(ParallelProcessing::parallelStream, 1_000_000) + " MS");
        System.out.println("The best process time(parallelStream2)=>" + measureSumPerformance(ParallelProcessing::parallelStream2, 1_000_000) + " MS");
